...
from app.models import user, profile, member, trainer, plan, membership, payment, attendance, workout, diet, association, notification, password_reset, receipt, lead, exercise_library, gym_settings  # noqa: F401
